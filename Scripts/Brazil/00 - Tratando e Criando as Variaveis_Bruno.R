...
## Add the variable with the names of the candidates:

e19 <- e19 %>%
  mutate(vote_name = rio::characterize(q12p1_b))


### Save processed RData to use in the next scripts without loading everything again

save(e19, file = 'eseb2018_working.RData')
